...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Decision: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  DecisionId: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  StoryTime: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  Subject: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  SubjectId: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  Vow: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  VowId: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  VowLedger: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  VowStatus: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  WorldState: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  ChapterInfo: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  ChapterInput: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  DecisionOption: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  IntegrityReport: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  SubjectKind: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  SubjectState: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  WorldEvent: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
  WorldEventInput: 'novel domain type is owned by packages/novel/novel/src/types.ts and documented in packages/novel/novel/README.md',
