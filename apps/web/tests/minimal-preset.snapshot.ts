...
// The minimal preset is a fixed bash + str_replace_editor composition, and the
// persistent bash shell (terminal-bash + tool-bash-persistent) has no pwsh
// twin on Windows (bash has no Windows runner) — the lane is POSIX-only.
