...
// The round trip drives a real bash call (the assembled Web URL, then the
// recorded tool execution); Windows ships no bash runner (the bundles gate
// bash to POSIX), so this lane is POSIX-only.
