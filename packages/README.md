...
| [`novel/`](novel/README.md) | Long-form fiction writing: world engine, plot vow ledger, creative decisions, chapter knowledge control, and the model-facing novel tools | Product — stable API |
