...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'novel',
    summary: 'The novel writing workspace service, published on `ctx.novel`.',
    description: 'The novel writing workspace service, published on `ctx.novel`.\n\nIds are minted by the service (`subject-1`, `event-1`, `vow-1`, `decision-1`) and stable for the life of the store: nothing is ever deleted, so the count-based sequence never reuses an id. Field values in world changes are plain text.',
    methods: [
      {
        signature: 'readonly root: string',
        description: 'The store\'s root directory (resolved).',
        parameters: [],
      },
      {
        signature: 'readonly db: DatabaseSync',
        description: 'The authoritative SQLite connection. Read access exists for the invariant companion and tests; mutations go through the service methods.',
        parameters: [],
      },
      {
        signature: 'createSubject(input: { kind: SubjectKind; name: string; summary?: string }): Subject',
        description: 'Register a subject in the world engine.',
        parameters: [{ name: 'input', description: 'kind, non-empty name, and optional summary.' }],
        returns: 'the stored subject.',
      },
      {
        signature: 'listSubjects(): Subject[]',
        description: 'Every registered subject, in id order.',
        parameters: [],
        returns: 'the subjects.',
      },
      {
        signature: 'getSubject(id: SubjectId): Subject | undefined',
        description: 'Fetch one subject by id.',
        parameters: [{ name: 'id', description: 'the subject id.' }],
        returns: 'the subject, or `undefined` when unknown.',
      },
      {
        signature: 'subjectState(id: SubjectId): SubjectState | undefined',
        description: 'Fold one subject\'s state at the latest recorded story time.',
        parameters: [{ name: 'id', description: 'the subject id.' }],
        returns: 'the folded state, or `undefined` when the subject is unknown.',
      },
      {
        signature: 'subjectStateAt(id: SubjectId, at: StoryTime): SubjectState | undefined',
        description: 'Fold one subject\'s state at a given story time.',
        parameters: [{ name: 'id', description: 'the subject id.' }, { name: 'at', description: 'the fold point; events strictly after it are ignored.' }],
        returns: 'the folded state, or `undefined` when the subject is unknown.',
      },
      {
        signature: 'worldState(): WorldState',
        description: 'The whole world at the latest recorded story time.',
        parameters: [],
        returns: 'the fold point and every subject\'s state at it.',
      },
      {
        signature: 'recordWorldEvent(input: WorldEventInput): WorldEvent',
        description: 'Record one world event and its subject changes in one transaction. A change references an existing subject and a non-empty field; each (subject, field) pair may appear once per event.',
        parameters: [{ name: 'input', description: 'story time, title, summary, and subject changes.' }],
        returns: 'the stored event.',
      },
      {
        signature: 'listWorldEvents(): WorldEvent[]',
        description: 'Every recorded world event, in story order.',
        parameters: [],
        returns: 'the events.',
      },
      {
        signature: 'latestStoryTime(): StoryTime | null',
        description: 'The latest recorded story time.',
        parameters: [],
        returns: 'the story time of the most recent event, or `null` when no event exists.',
      },
      {
        signature: 'plantVow(input: { title: string promise: string at: StoryTime payoffTarget?: string note?: string }): Vow',
        description: 'Plant a plot vow.',
        parameters: [{ name: 'input', description: 'title, promise, planting story time, and optional target and note.' }],
        returns: 'the planted vow.',
      },
      {
        signature: 'advanceVow(id: VowId, input: { at: StoryTime; detail: string }): Vow',
        description: 'Advance a vow: tighten its promise, keeping it open.',
        parameters: [{ name: 'id', description: 'the vow id.' }, { name: 'input', description: 'the story time and a non-empty detail of the advance.' }],
        returns: 'the updated vow.',
      },
      {
        signature: 'payOffVow(id: VowId, input: { at: StoryTime; detail: string }): Vow',
        description: 'Pay a vow off: resolve it.',
        parameters: [{ name: 'id', description: 'the vow id.' }, { name: 'input', description: 'the story time and a non-empty detail of the payoff.' }],
        returns: 'the updated vow.',
      },
      {
        signature: 'abandonVow(id: VowId, input: { at: StoryTime; detail: string }): Vow',
        description: 'Abandon a vow: drop it without resolving.',
        parameters: [{ name: 'id', description: 'the vow id.' }, { name: 'input', description: 'the story time and a non-empty detail of the abandonment.' }],
        returns: 'the updated vow.',
      },
      {
        signature: 'listVows(filter: { status?: VowStatus } = {}): VowLedger[]',
        description: 'List vows, optionally filtered by status, oldest planted first.',
        parameters: [{ name: 'filter', description: 'optional status filter.' }],
        returns: 'each vow with its full transition history.',
      },
      {
        signature: 'recordDecision(input: { context: string; options: DecisionOption[] }): Decision',
        description: 'Record a creative decision.',
        parameters: [{ name: 'input', description: 'the context and at least one non-empty, unique option.' }],
        returns: 'the stored decision, open.',
      },
      {
        signature: 'decide(id: DecisionId, input: { chosen: string; rationale?: string }): Decision',
        description: 'Close an open decision by choosing one of its options.',
        parameters: [{ name: 'id', description: 'the decision id.' }, { name: 'input', description: 'the chosen option label and an optional rationale.' }],
        returns: 'the updated decision.',
      },
      {
        signature: 'listDecisions(): Decision[]',
        description: 'Every recorded decision, newest recorded first.',
        parameters: [],
        returns: 'the decisions.',
      },
      {
        signature: 'upsertChapter(input: ChapterInput): ChapterInfo',
        description: 'Insert a chapter or update the knowledge-control fields of an existing one. Omitted knowledge fields keep their previous values on update.',
        parameters: [{ name: 'input', description: 'the chapter number, title, and knowledge fields.' }],
        returns: 'the stored chapter.',
      },
      {
        signature: 'getChapter(number: number): ChapterInfo | undefined',
        description: 'Fetch one chapter by number.',
        parameters: [{ name: 'number', description: 'the chapter number.' }],
        returns: 'the stored chapter, or `undefined` when unknown.',
      },
      {
        signature: 'listChapters(): ChapterInfo[]',
        description: 'Every stored chapter, in number order.',
        parameters: [],
        returns: 'the chapters.',
      },
      {
        signature: 'async exportMarkdown(): Promise<string[]>',
        description: 'Write the Markdown exports under the store root: `world-engine/`, `plot/`, `decisions/`, and `chapters/` documents, all deterministic.',
        parameters: [],
        returns: 'the absolute paths written.',
      },
      {
        signature: 'checkIntegrity(): IntegrityReport',
        description: 'Check the store\'s durable consistency: orphan rows, unparsable story times, and payoffs without a recorded payoff transition.',
        parameters: [],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'Decision',
    declaration: 'export interface Decision {\n    readonly id: DecisionId;\n    readonly createdAt: string;\n    readonly context: string;\n    readonly options: readonly DecisionOption[];\n    readonly chosen: string | null;\n    readonly rationale: string;\n    readonly status: \'open\' | \'decided\';\n}',
  },
  {
    name: 'DecisionId',
    declaration: 'export type DecisionId = Branded<\'novel:decision\'>;',
  },
  {
    name: 'DecisionOption',
  ...
  {
    name: 'Subject',
    declaration: 'export interface Subject {\n    readonly id: SubjectId;\n    readonly kind: SubjectKind;\n    readonly name: string;\n    readonly summary: string;\n}',
  },
  {
    name: 'SubjectId',
    declaration: 'export type SubjectId = Branded<\'novel:subject\'>;',
  },
  {
    name: 'SubjectKind',
    declaration: 'export type SubjectKind = \'character\' | \'location\' | \'faction\' | \'object\';',
  },
  {
    name: 'SubjectState',
    declaration: 'export interface SubjectState {\n    readonly subject: Subject;\n    readonly fields: Readonly<Record<string, string>>;\n    readonly updatedAt: StoryTime | null;\n}',
  },
  {
  ...
  {
    name: 'Vow',
    declaration: 'export interface Vow {\n    readonly id: VowId;\n    readonly title: string;\n    readonly promise: string;\n    readonly plantedAt: StoryTime;\n    readonly status: VowStatus;\n    readonly payoffTarget: string;\n    readonly note: string;\n}',
  },
  {
    name: 'VowId',
    declaration: 'export type VowId = Branded<\'novel:vow\'>;',
  },
  {
    name: 'VowLedger',
    declaration: 'export interface VowLedger {\n    readonly vow: Vow;\n    readonly transitions: readonly VowTransition[];\n}',
  },
  {
    name: 'VowStatus',
    declaration: 'export type VowStatus = \'planted\' | \'advanced\' | \'paid_off\' | \'abandoned\';',
  },
  {
    name: 'VowTransition',
    declaration: 'export interface VowTransition {\n    readonly action: \'plant\' | \'advance\' | \'payoff\' | \'abandon\';\n    readonly at: StoryTime;\n    readonly detail: string;\n}',
  },
  {
    name: 'WebBootEntry',
  ...
  {
    name: 'WorldChangeInput',
    declaration: 'export interface WorldChangeInput {\n    readonly subjectId: SubjectId;\n    readonly field: string;\n    readonly value: string;\n}',
  },
  {
    name: 'WorldEvent',
  ...
  {
    name: 'WorldEventId',
    declaration: 'export type WorldEventId = Branded<\'novel:event\'>;',
  },
  {
    name: 'WorldEventInput',
    declaration: 'export interface WorldEventInput {\n    readonly storyTime: StoryTime;\n    readonly title: string;\n    readonly summary?: string;\n    readonly changes?: readonly WorldChangeInput[];\n}',
  },
  {
    name: 'WorldState',
    declaration: 'export interface WorldState {\n    readonly at: StoryTime | null;\n    readonly subjects: readonly SubjectState[];\n}',
  },
]
