...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-novel NovelWorkspaceTab id \'novel\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-novel NovelFloatButton id \'novel-seal\' (novel studio seal)',
      'client-ui-novel NovelProjectExplorer id \'novel-studio\' (fullscreen novel studio)',
      'client-ui-novel NovelFloatButton id \'tavern-seal\' (tavern seal)',
      'client-ui-novel NovelProjectExplorer id \'tavern-studio\' (fullscreen tavern)',
    ],
    replaceRisk: 'none',
