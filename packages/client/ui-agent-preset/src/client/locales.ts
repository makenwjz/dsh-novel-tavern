...
export type AgentPresetSettingsKey =
  ...
  | 'presetNovelName' | 'presetNovelDescription'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetNovelName: 'Novel mode',
  presetNovelDescription:
    'All Standard mode capabilities plus a long-fiction writing workspace: world building, plot vows, creative decisions, and chapter knowledge control.',
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetNovelName: '小说模式',
  presetNovelDescription: '具备标准模式的全部能力，并提供长篇小说创作的工作区：世界设定、情节伏笔、创作决策与章节知识控制。',
  duplicate: '复制',
...
const BUILT_IN_PRESET_KEYS: Readonly<Partial<Record<string, PresetLocaleKeys>>> = {
  ...
  novel: { name: 'presetNovelName', description: 'presetNovelDescription' },
}
