...
import {
  tavernAdvanceStageRequestSchema,
  tavernSetGreetingRequestSchema,
  tavernSetMvuRequestSchema,
  tavernSetPersonaRequestSchema,
  tavernImportChatRequestSchema,
  tavernSaveJailbreakRequestSchema,
  tavernListJailbreaksRequestSchema,
  tavernDeleteJailbreakRequestSchema,
  tavernBindingRequestSchema,
  tavernScoreCharacterRequestSchema,
  tavernDeleteCharacterRequestSchema,
  tavernDeleteWorldBookRequestSchema,
  tavernSetWorldBookEntryEnabledRequestSchema,
  tavernImportCharacterRequestSchema,
  tavernImportWorldBookRequestSchema,
  tavernImportPromptPresetRequestSchema,
  tavernListPromptPresetsRequestSchema,
  tavernDeletePromptPresetRequestSchema,
  tavernUpdateCharacterRequestSchema,
  tavernUpdateCharacterScriptsRequestSchema,
  tavernSaveWorldBookEntryRequestSchema,
  tavernDeleteWorldBookEntryRequestSchema,
  tavernLeanRequestSchema,
  tavernListCharactersRequestSchema,
  tavernListWorldBooksRequestSchema,
  tavernSetBindingRequestSchema,
  tavernSetLeanRequestSchema,
  tavernStartRoleplayRequestSchema,
  tavernStopRoleplayRequestSchema,
  tavernProjectTreeRequestSchema,
  tavernCharacterImageRequestSchema,
} from '../api/tavern.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'tavern.listWorldBooks': { schema: tavernListWorldBooksRequestSchema, invoke: (api, r) => api.tavern.listWorldBooks(r) },
  'tavern.importWorldBook': { schema: tavernImportWorldBookRequestSchema, invoke: (api, r) => api.tavern.importWorldBook(r) },
  'tavern.importPromptPreset': { schema: tavernImportPromptPresetRequestSchema, invoke: (api, r) => api.tavern.importPromptPreset(r) },
  'tavern.listPromptPresets': { schema: tavernListPromptPresetsRequestSchema, invoke: (api, r) => api.tavern.listPromptPresets(r) },
  'tavern.deletePromptPreset': { schema: tavernDeletePromptPresetRequestSchema, invoke: (api, r) => api.tavern.deletePromptPreset(r) },
  'tavern.deleteWorldBook': { schema: tavernDeleteWorldBookRequestSchema, invoke: (api, r) => api.tavern.deleteWorldBook(r) },
  'tavern.setWorldBookEntryEnabled': { schema: tavernSetWorldBookEntryEnabledRequestSchema, invoke: (api, r) => api.tavern.setWorldBookEntryEnabled(r) },
  'tavern.listCharacters': { schema: tavernListCharactersRequestSchema, invoke: (api, r) => api.tavern.listCharacters(r) },
  'tavern.importCharacter': { schema: tavernImportCharacterRequestSchema, invoke: (api, r) => api.tavern.importCharacter(r) },
  'tavern.updateCharacter': { schema: tavernUpdateCharacterRequestSchema, invoke: (api, r) => api.tavern.updateCharacter(r) },
  'tavern.updateCharacterScripts': { schema: tavernUpdateCharacterScriptsRequestSchema, invoke: (api, r) => api.tavern.updateCharacterScripts(r) },
  'tavern.saveWorldBookEntry': { schema: tavernSaveWorldBookEntryRequestSchema, invoke: (api, r) => api.tavern.saveWorldBookEntry(r) },
  'tavern.deleteWorldBookEntry': { schema: tavernDeleteWorldBookEntryRequestSchema, invoke: (api, r) => api.tavern.deleteWorldBookEntry(r) },
  'tavern.deleteCharacter': { schema: tavernDeleteCharacterRequestSchema, invoke: (api, r) => api.tavern.deleteCharacter(r) },
  'tavern.binding': { schema: tavernBindingRequestSchema, invoke: (api, r) => api.tavern.binding(r) },
  'tavern.setBinding': { schema: tavernSetBindingRequestSchema, invoke: (api, r) => api.tavern.setBinding(r) },
  'tavern.startRoleplay': { schema: tavernStartRoleplayRequestSchema, invoke: (api, r) => api.tavern.startRoleplay(r) },
  'tavern.stopRoleplay': { schema: tavernStopRoleplayRequestSchema, invoke: (api, r) => api.tavern.stopRoleplay(r) },
  'tavern.lean': { schema: tavernLeanRequestSchema, invoke: (api, r) => api.tavern.lean(r) },
  'tavern.setLean': { schema: tavernSetLeanRequestSchema, invoke: (api, r) => api.tavern.setLean(r) },
  'tavern.advanceStage': { schema: tavernAdvanceStageRequestSchema, invoke: (api, r) => api.tavern.advanceStage(r) },
  'tavern.setGreeting': { schema: tavernSetGreetingRequestSchema, invoke: (api, r) => api.tavern.setGreeting(r) },
  'tavern.setMvu': { schema: tavernSetMvuRequestSchema, invoke: (api, r) => api.tavern.setMvu(r) },
  'tavern.setPersona': { schema: tavernSetPersonaRequestSchema, invoke: (api, r) => api.tavern.setPersona(r) },
  'tavern.importChat': { schema: tavernImportChatRequestSchema, invoke: (api, r) => api.tavern.importChat(r) },
  'tavern.saveJailbreak': { schema: tavernSaveJailbreakRequestSchema, invoke: (api, r) => api.tavern.saveJailbreak(r) },
  'tavern.listJailbreaks': { schema: tavernListJailbreaksRequestSchema, invoke: (api, r) => api.tavern.listJailbreaks(r) },
  'tavern.deleteJailbreak': { schema: tavernDeleteJailbreakRequestSchema, invoke: (api, r) => api.tavern.deleteJailbreak(r) },
  'tavern.scoreCharacter': { schema: tavernScoreCharacterRequestSchema, invoke: (api, r) => api.tavern.scoreCharacter(r) },
  'tavern.projectTree': { schema: tavernProjectTreeRequestSchema, invoke: (api, r) => api.tavern.projectTree(r) },
  'tavern.characterImage': { schema: tavernCharacterImageRequestSchema, invoke: (api, r) => api.tavern.characterImage(r) },
