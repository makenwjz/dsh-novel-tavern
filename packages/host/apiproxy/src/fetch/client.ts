...
export interface IApiClient {
  ...
  tavern: {
    ...
    startRoleplay(payload: RequestPayload<'tavern.startRoleplay'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'tavern.startRoleplay'>>>
    stopRoleplay(payload: RequestPayload<'tavern.stopRoleplay'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'tavern.stopRoleplay'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'tavern.startRoleplay': tavernStartRoleplayValueSchema,
  'tavern.stopRoleplay': tavernStopRoleplayValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly tavern: IApiClient['tavern'] = {
    ...
    startRoleplay: (payload, signal) => this.callUnary('tavern.startRoleplay', payload, signal),
    stopRoleplay: (payload, signal) => this.callUnary('tavern.stopRoleplay', payload, signal),
