...
import type { TavernApi } from './tavern.ts'
...
export interface RpcMethodMap {
  ...
  'tavern.listWorldBooks': TavernApi['listWorldBooks']
  'tavern.importWorldBook': TavernApi['importWorldBook']
  'tavern.importPromptPreset': TavernApi['importPromptPreset']
  'tavern.listPromptPresets': TavernApi['listPromptPresets']
  'tavern.deletePromptPreset': TavernApi['deletePromptPreset']
  'tavern.deleteWorldBook': TavernApi['deleteWorldBook']
  'tavern.setWorldBookEntryEnabled': TavernApi['setWorldBookEntryEnabled']
  'tavern.listCharacters': TavernApi['listCharacters']
  'tavern.importCharacter': TavernApi['importCharacter']
  'tavern.updateCharacter': TavernApi['updateCharacter']
  'tavern.updateCharacterScripts': TavernApi['updateCharacterScripts']
  'tavern.saveWorldBookEntry': TavernApi['saveWorldBookEntry']
  'tavern.deleteWorldBookEntry': TavernApi['deleteWorldBookEntry']
  'tavern.deleteCharacter': TavernApi['deleteCharacter']
  'tavern.binding': TavernApi['binding']
  'tavern.setBinding': TavernApi['setBinding']
  'tavern.startRoleplay': TavernApi['startRoleplay']
  'tavern.stopRoleplay': TavernApi['stopRoleplay']
  'tavern.lean': TavernApi['lean']
  'tavern.setLean': TavernApi['setLean']
  ...
  'tavern.saveJailbreak': TavernApi['saveJailbreak']
  'tavern.listJailbreaks': TavernApi['listJailbreaks']
  'tavern.deleteJailbreak': TavernApi['deleteJailbreak']
