  ...
  return {
    ...
    tavern: {
      async listWorldBooks(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { worldbooks: [] } } }
      },
      ...
      async listCharacters(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { characters: [] } } }
      },
      ...
      async binding(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { binding: null } } }
      },
      async setBinding(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { binding: request.payload.binding } } }
      },
      async startRoleplay(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { binding: { mode: 'tavern', worldbookIds: request.payload.worldbookIds, characterId: request.payload.characterId ?? null, ...(request.payload.characterIds === undefined ? {} : { characterIds: request.payload.characterIds }) } } } }
      },
      async stopRoleplay(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { binding: null } } }
      },
      async lean(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { lean: false } } }
      },
      async setLean(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { lean: request.payload.lean } } }
      },
      ...
      async projectTree(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { worldbooks: [], characters: [] } } }
      },
      async characterImage(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { bytesB64: 'aGVsbG8=' } } }
      },
    },
